...
% Text Node
\draw (305.69,34.53) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textbf{{\footnotesize \textcolor[rgb]{0.10,0.44,0.87}{Pulse Shaping}}}};
% Text Node
...
% Text Node
\draw (290.23,236.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textbf{{\footnotesize \textcolor[rgb]{0.22,0.68,0.42}{Pulse Discrimination}}}};
% Text Node
...
% Text Node
\draw (150.9,317.64) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textbf{{\footnotesize \textcolor[rgb]{0.80,0.60,0}{Pulse Sampling}}}};
% Text Node
\draw (149,244.28) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {$N_{\text{bin}} \propto h\nu$};
% Text Node
\draw (403.5,281) node [anchor=north west][inner sep=0.75pt]  [font=\tiny] [align=left] {$C_{H}$};
\end{tikzpicture}