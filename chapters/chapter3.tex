...
\begin{table}[H]
  ...
  \end{tabular*}
\end{table}
As introduced, the dosimeter must be placed on a PMMA phantom during the calibration. For $H_p(10)$ the ISO water slab phantom is used, since it
reproduces the backscatter of the trunk of the body and therefore the conditions under which the dosimeter is worn. It consists of a PMMA shell of 30 $\times$ 30 $\times$ 15~cm, with a 2.5~mm front wall and 10~mm remaining walls, filled with water~\cite{ISO3}. A phantom replicating these dimensions was built for this work, but it was not filled with water due to the risk of leakage. The DORI test board was taped to the front wall of the phantom, with its photosensitive area aligned with the centre of the tube. Custom 3D-printed supports were made to hold the filters, and these sit on an alignment rail together with the phantom. The setup is shown in Fig.~\ref{fig:setup}. The centre of the plastic scintillator entrance face is placed 1~m away from the tube, and this position is taken as the reference measurement point, marked by the red star in the figure. The \emph{air KERMA} was measured with the transparent detector of the RaySafe Xi~\cite{raysafe}. The instrument was last calibrated in October 2013 and the product has since been discontinued, however, it was the only reference available. For these measurements the phantom and the dosimeter are removed from the rail and the centre of the ion chamber is placed at the reference point. All acquisitions were made at a tube current of 0.5~mA for 120~s, and the spectrum and average \emph{air KERMA} rate from DORI and the ion chamber were recorded, respectively. 
