...
\begin{figure}[H]
  ...
  \caption[Pulse height spectra and decay schemes of the CsI(Tl) calibration sources.]{%
    ...
    calibration sources, with the decay scheme of each source beneath. Blue
    arrows denote $\alpha$ decay, green electron capture and yellow $\gamma$
    emission.}
  \label{fig:spectra}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\linewidth]{images/fit_csi.pdf}
